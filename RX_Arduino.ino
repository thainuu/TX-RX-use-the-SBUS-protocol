...
const uint64_t pipeIn = 161202270703LL;
...
void loop() {
 ...
 int randNumber = 1;
  ...
  rcChannels[0] = map(data.yaw, 0, 255, 1000, 2000);
  rcChannels[1] = map(data.pitch, 0, 255, 1000, 2000);
  rcChannels[2] = map(data.throttle, 0, 255, 1000, 2000); //roll
  rcChannels[3] = map(data.roll, 0, 255, 1000, 2000);
  rcChannels[4] = map(data.analog1, 0, 255, 1000, 2000);
  rcChannels[5] = map(data.analog2, 0, 255, 1000, 2000);
  rcChannels[6] = map(data.aux1, 0, 1, 1000, 2000);
  rcChannels[7] = map(data.aux2, 0, 1, 1000, 2000);
  rcChannels[8] = map(data.aux3, 0, 1, 1000, 2000);
  rcChannels[9] = map(data.aux4, 0, 1, 1000, 2000);
  rcChannels[10] = map(data.aux5, 0, 1, 1000, 2000);
  rcChannels[11] = map(data.aux6, 0, 1, 1000, 2000);
  rcChannels[12] = map(data.aux7, 0, 1, 1000, 2000);
  rcChannels[13] = map(data.aux8, 0, 1, 1000, 2000);
